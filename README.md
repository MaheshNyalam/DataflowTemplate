...
* [`src/main/java/com/example/App.java`](src/main/java/com/example/KafkaToKafka.java): the application source file, containing the [`main` method](src/main/java/com/example/KafkaToKafka.java). The _main class_ is `com.example.KafkaToKafka`.
